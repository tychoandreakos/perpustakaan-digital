                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right">
                            <a :href="this.route" class="btn btn-sm btn-primary"><i
                                    class="ni ni-fat-add text-white"></i> Tambah Jurusan</a>
                        </div>
                    </div>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            deleted(val) {
                this.$swal({
                    ...
                    if (result.value) {
                        axios.post('/pustakawan/jurusan/' + val, {
                                _method: 'DELETE'
                            })
                            .then(res => {
                                this.$swal({
        ...
        created() {
            ...
            Fire.$on('searching', () => {
                ...
                axios.get('/pustakawan/jurusan-search?q=' + query)
                    .then(res => {
                        // console.log(res)
                        this.datas = res.data
                    })
