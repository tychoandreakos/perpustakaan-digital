                        ...
                        <div class="row">
                            <div class="col col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" :value="this.denda.user.id" disabled type="text"
                            ...
                            <div class="col col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" :value="this.denda.user.name | capitalize" disabled type="text"
                                        class="form-control" placeholder="Nama Gmd">
                                </div>
                            </div>
                        </div>
