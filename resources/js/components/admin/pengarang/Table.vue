            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="mb-0">Daftar Pengarang</h3>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                <tr v-for="item in datas.data" :key="item.id">
                                    ...
                                    <td>
                                        {{ item.nama_pengarang | capitalize }}
                                    </td>
                                    <td>
                                        {{ item.updated_at }}
                                    </td>
    ...
    export default {
        ...
        methods: {
            ...
            deleted(val) {
                this.$swal({
                    ...
                    if (result.value) {
                        axios.post('/pustakawan/pengarang/' + val, {
                                _method: 'DELETE'
                            })
                            .then(res => {
                                this.$swal({
        ...
        created() {
            ...
            Fire.$on('searching', () => {
                ...
                axios.get('/pustakawan/pengarang-search?q=' + query)
                    .then(res => {
                        // console.log(res)
                        this.datas = res.data
                    })
