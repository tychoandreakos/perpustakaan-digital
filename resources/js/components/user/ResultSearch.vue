<template>
    <div>
        <div class="container mt-4">
            ...
            <p>Ditemukan {{ this.result.length }} hasil dengan kata kunci {{ this.keyword.toUpperCase() }}</p>

            <template v-if="this.result.length > 0">
                <div class="card mt-4" v-for="item in this.result" :key="item.id">
                    <div class="card-body">
                        <div class="row">
                            <div class="col col-md-3">
                                <img class="text-center mx-auto d-block mt-3"
                            ...
                            <div class="col col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col col-md-8">
                                        {{ item.buku_transaksi[0].penerbit.nama_penerbit | capitalize }}
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col col-md-8">
                                        <!-- <span v-for="bibliobigrafi in item.bibliobigrafi[0]" :key="bibliobigrafi">{{ bibliobigrafi.gmd.nama_gmd }}</span> -->
                                        GTM
                                    </div>
                                </div>
                            </div>
