                ...
                <div class="col-xl-4">
                    <div class="card shadow">
                        <div class="card-header bg-transparent">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h6 class="text-uppercase text-muted ls-1 mb-1">Statistik Pinjaman</h6>
                                    <h2 class="mb-0">Total Pinjaman</h2>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <!-- Chart -->
                            <div class="chart">
                                <canvas id="chart-orders-pinjam" class="chart-canvas"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
